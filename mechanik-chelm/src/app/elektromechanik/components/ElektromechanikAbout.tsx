    ...
    <section className="flex flex-col items-center justify-center m-10">
      <div className="flex flex-col items-start justify-between md:flex-row">
        <div>
          <Image
            ...
            height={500}
            width={500}
            alt="Naprawa elektroniki samochodowej"
        ...
        <div className="max-w-lg ">
          ...
          <p className="max-w-2xl m-10 font-light text-left text-gray-500">
            ...
            quis! Veniam, ex aspernatur? Reprehenderit blanditiis earum, iure
            distinctio, dolorum soluta molestiae, perferendis natus autem
            architecto cum?
          </p>
          <p className="max-w-2xl m-10 font-light text-left text-gray-500">
            Lorem ipsum dolor, sit amet consectetur adipisicing elit. Sint,
      ...
      <div className="flex flex-col items-center justify-center">
        ...
        <p className="m-10 font-light text-center text-gray-500">
          ...
          najwyższym poziomie w konkurencyjnej cenie i zawsze na czas! Zachęcamy
          do zapoznania się z naszą ofertą.
        </p>
        <div className="">
          <h5 className="gap-4 font-bold tracking-wide text-center text-gray-700 text-md md:text-xl max-w font-OpenSans">
            ...
            <div className="max-w-md">
              <ul className="mt-5">
                <li>
                  ...
                  />{" "}
                  Polecamy diagnostykę komputerową wszystkich marek z rynku
                  europejskiego, azjatyckiego i amerykańskiego – specjalizacja:
                  grupa VW AUDI, Opel, Renault, PSA
                </li>
                <li>
                  <FontAwesomeIcon
                    icon={faCheck}
              ...
              <ul className="mt-5">
                ...
                <li>
                  <FontAwesomeIcon
                    ...
                    style={{ color: "#1e69b8", width: "21px", height: "21px" }}
                  />{" "}
                  Naprawa i diagnostyka elektroniki
                </li>
                <li>
                  <FontAwesomeIcon
                    icon={faCheck}
                    style={{ color: "#1e69b8", width: "21px", height: "21px" }}
                  />{" "}
                  Układy wtryskowe benzyny i diesla, abs, air-bag, układy
                  komfortu itp.
                </li>
              </ul>
            </div>
              ...
              <div className="max-w-md">
                <ul className="mt-5">
                  <li>
                    ...
                    />{" "}
                    Pomiar zdolności rozruchowej akumulatorów
                  </li>
                  <li>
                    <FontAwesomeIcon
                      icon={faCheck}
              ...
              <div className="max-w-md">
                <ul className="mt-5">
                  ...
                  <li>
                    ...
                    />{" "}
                    Blokady złącza diagnostycznego OBD
                  </li>
                  <li>
                    <FontAwesomeIcon
                      icon={faCheck}
                  ...
                  <li>
                    ...
                    />{" "}
                    Sterowniki radiowe centralnego zamka
                  </li>
                  <li>
                    <FontAwesomeIcon
                      icon={faCheck}
              ...
              <div className="max-w-md">
                <ul className="mt-5">
                  ...
                  <li>
                    ...
                    />{" "}
                    Dodatkowe oświetlenie wnętrza LED
                  </li>
                  <li>
                    <FontAwesomeIcon
                      icon={faCheck}
                  ...
                  <li>
                    ...
                    />{" "}
                    Czujniki parkowania montaż naprawa diagnostyka
                  </li>
                </ul>
              </div>
              <div className="max-w-md">
